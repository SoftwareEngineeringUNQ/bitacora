...
- Éxito del proyecto = Cuando tiempo, costo y alcance son cubiertos de acuerdo a las expectativas.
...
*Hablamos sobre una posible estructura de un proyecto con Ruby.
gemfile, rakefile, /model, /spec.
